...
@implementation UITextView_twPlaceHolder
...
- (void)drawRect:(CGRect)rect
{
    if( [[self placeholder] length] > 0 )
    {
        if (_placeHolderLabel == nil ) {
            ...
            _placeHolderLabel = [[UILabel alloc] initWithFrame:CGRectMake(originX, originY,self.bounds.size.width - originX*2,0)];
